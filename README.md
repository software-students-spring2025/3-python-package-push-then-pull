...
- Kivy Dependencies: You many need to install additional dependencies depending on your platform. Please refer to the [Kivy installation guide](https://kivy.org/doc/stable/gettingstarted/installation.html).
